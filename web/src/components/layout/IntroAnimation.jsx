...
function IntroAnimation() {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 bg-white flex items-center justify-center transition-transform duration-1000 ease-in-out border-b border-surface-border shadow-sm ${
