  ...
  return (
    <aside className="bg-surface border-l border-surface-border p-6 flex flex-col gap-6 overflow-y-auto">
      ...
      <section className="flex-2 flex flex-col min-h-[300px]">
        <h3 className="text-xs uppercase font-bold text-brand-secondary mb-4 tracking-widest">Podgląd 3D</h3>
      ...
      <section className="flex flex-col gap-3">
        <h3 className="text-xs uppercase font-bold text-brand-secondary mb-2 tracking-widest">System</h3>
